...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("rasterize_to_pixels_fwd_pgsr", &gsplat::rasterize_to_pixels_fwd_pgsr_tensor);
    m.def("rasterize_to_pixels_bwd_pgsr", &gsplat::rasterize_to_pixels_bwd_pgsr_tensor);
}
